 ...
 describe(Deck) do
   ...
   describe('#draw') do
     it 'draws from a new unshuffled deck' do
       ...
       test_card1 = Card.create({:value => 0, :suit => 0, :deck_card_order => 0, :deck_id => test_deck.id(), :hand_id => 0, :flipped => false})
       test_card2 = Card.create({:value => 0, :suit => 1, :deck_card_order => 0, :deck_id => test_deck.id(), :hand_id => 0, :flipped => false})
       test_card3 = Card.create({:value => 0, :suit => 2, :deck_card_order => 0, :deck_id => test_deck.id(), :hand_id => 0, :flipped => false})
       test_card4 = Card.create({:value => 0, :suit => 3, :deck_card_order => 0, :deck_id => test_deck.id(), :hand_id => 0, :flipped => false})
